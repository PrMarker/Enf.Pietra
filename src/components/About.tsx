...
const benefits = [
  {
    ...
    title: 'Enfermeira registrada no COREN',
    desc: 'Profissional devidamente registrada no Conselho Regional de Enfermagem, garantindo segurança e qualidade nos procedimentos.'
  },
  {
    icon: (
      <span className="inline-block bg-[#f7e6e0] rounded-full p-3 mb-4">
